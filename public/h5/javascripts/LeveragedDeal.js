	...
	function get_lever_data() {
        ...
        //2020-12-1  去掉登录默认
        if(!get_user()){
            var mult ='<span data-id="10">10倍</span><span data-id="20">20倍</span><span data-id="30">30倍</span><span data-id="50">50倍</span><span data-id="100">100倍</span>';
			
		    $('.multiple_sel').html(mult);
		    
		    
		    shareHtml = '';
		    shareHtml += '<span data-id="1" >1手</span>'
		    shareHtml += '<span data-id="10" >10手</span>'
		    shareHtml += '<span data-id="50" >50手</span>'
		    shareHtml += '<span data-id="100" >100手</span>'
