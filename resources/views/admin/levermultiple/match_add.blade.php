...
<div class="layui-form">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="checkbox" name="open_lever" value="1" title="合约开启" @if (isset($currency_match)) {{ $currency_match->open_lever == 1 ? 'checked' : '' }} @else checked @endif>
        </div>
    </div>
    <div class="layui-form-item">
        <label for="currency_id" class="layui-form-label">每手数量</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="lever_share_num" placeholder="合约交易每手数量" value="{{ $currency_match->lever_share_num ?? 1.00 }}" >
        </div>
    </div>
    <div class="layui-form-item">
        <label for="currency_id" class="layui-form-label">合约手续费</label>
        <div class="layui-input-block">
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="lever_trade_fee" placeholder="合约交易手费续" value="{{ $currency_match->lever_trade_fee ?? 0.00 }}" >
            </div>
