...
<div class="layui-layout layui-layout-admin kit-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-right kit-nav">
            ...
            <li class="layui-nav-item">
                <a href="javascript:;">
                    <img src="/images/0.jpg" class="layui-nav-img"> {{$admin->username}}
                </a>
                <!-- <dl class="layui-nav-child">
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="kitNavbar" kit-navbar>
                    ...
                    <!-- <dl class="layui-nav-child" style="display:none">
                        <dd>
                            <a href="javascript:;" kit-target data-options="{url:'/admin/levertolegal/index',icon:'&#xe658;',title:'划转审核',id:'2'}">
                                <i class="layui-icon">&#xe658;</i><span> 合约划转审核</span>
                            </a>
                        </dd>
                    </dl> -->
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" kit-target data-options="{url:'/admin/levermultiple/index',icon:'&#xe658;',title:'合约手数倍数',id:'30'}">
                ...
                <li class="layui-nav-item ">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" kit-target data-options="{url:'/admin/krobot/index', icon:'&#xe60e;', title:'平台币机器人', id:'99'}">
                                <i class="layui-icon">&#xe60e;</i>
                                <span>平台币机器人</span>
                            </a>
                        </dd>
