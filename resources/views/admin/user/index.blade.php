...
@section('page-content')
    ...
    <button class="layui-btn layui-btn-normal" style="display: none;" onclick="javascrtpt:window.location.href='/admin/user/csv'">
...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-xs" lay-event="users_wallet">资产管理</a>
