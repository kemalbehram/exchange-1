    ...
    <div class="layui-field-box">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input class="layui-input" lay-verify="required" name="sms_internal_appid" value="{{$setting['sms_internal_appid'] ?? '' }}" placeholder="" autocomplete="off">
                </div>
            </div>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" style="width: 240px">
                    <input class="layui-input" type="password" lay-verify="required" name="sms_internal_appkey" value="{{$setting['sms_internal_appkey'] ?? '' }}" placeholder="" autocomplete="off">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input class="layui-input" lay-verify="required" name="sms_internat_appid" value="{{$setting['sms_internat_appid'] ?? '' }}" placeholder="" autocomplete="off">
                </div> 
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">国际短信appkey</label>
                <div class="layui-input-inline" style="width: 240px">
                    <input class="layui-input" type="password" lay-verify="required" name="sms_internat_appkey" value="{{$setting['sms_internat_appkey'] ?? '' }}" placeholder="" autocomplete="off">
                </div>
            </div>
        </div>
    </div>
