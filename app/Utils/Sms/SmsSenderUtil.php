...
class SmsSenderUtil {
    ...
    public function calculateSig($secretkey, $random, $curTime, $phoneNumbers) {
    ...
    public function calculateSigForTemplAndPhoneNumbers($secretkey, $random, $curTime, $phoneNumbers) {
        $phoneNumbersString = $phoneNumbers[0];
        for ($i = 1; $i < count($phoneNumbers); $i++) {
            $phoneNumbersString .= ("," . $phoneNumbers[$i]);
        }
    ...
    public function calculateSigForTempl($secretkey, $random, $curTime, $phoneNumber) {
